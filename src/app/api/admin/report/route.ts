  ...
  try {
    ...
    const reportData = {
      merchant: {
        ...
        name: merchant.name,
        slug: merchant.slug,
        contact_name: merchant.contact_name || merchant.push_settings?.contact_name || '',
        contact_phone: merchant.contact_phone || merchant.push_settings?.contact_phone || '',
        contact_email: merchant.contact_email || merchant.push_settings?.contact_email || '',
